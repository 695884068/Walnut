...
namespace Walnut
{
        ...
        : mPath(path)
    {
        ...
        if (data)
        {
            ...
            WN_CORE_ASSERT(internalFormat & dataFormat, "Format not supported!");
    ...
    void OpenGLTexture2D::SetData(void* data, uint32_t size)
    {
        ...
        WN_CORE_ASSERT(size == mWidth * mHeight * bpp, "Data must be entire texture!");
    ...
    void OpenGLCubeMapTexture::Generate()
    {
        ...
        for (unsigned int i = 0; i < mPaths.size(); i++)
        {
            ...
            {
                WN_CORE_ERROR("Cubemap don't loaded correctly!");
                stbi_image_free(data);
            }
        }
