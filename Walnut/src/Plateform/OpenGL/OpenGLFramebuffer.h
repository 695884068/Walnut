...
namespace Walnut
{
    ...
    public:
        ...
        virtual uint32_t GetColorAttachmentRendererID(uint32_t index = 0) const override { WN_CORE_ASSERT(index < mColorAttachments.size()); return mColorAttachments[index]; }
