...
#include "Walnut/Sence/Component/Transform/TransformComponent.h"
#include "Walnut/Sence/Component/Camera/CameraComponent.h"
#include "Walnut/Sence/Component/Physics/2D/BoxCollider2DComponent.h"
#include "Walnut/Sence/Component/Physics/2D/CircleCollider2DComponent.h"
#include "Walnut/Sence/Component/Physics/2D/Rigidbody2DComponent.h"
#include "Entity.h"
#include "Walnut/Asset/ModeManager.h"
#include "Walnut/Renderer/Renderer2D.h"
#if 0
...
namespace Walnut
{
	static b2BodyType Rigidbody2DTypeToBox2DBody(Rigidbody2DComponent::BodyType bodyType)
	{
		switch (bodyType)
		{
		case Walnut::Rigidbody2DComponent::BodyType::Static:		return b2_staticBody;
		case Walnut::Rigidbody2DComponent::BodyType::Dynamic:		return b2_dynamicBody;
		case Walnut::Rigidbody2DComponent::BodyType::Kinematic:	return b2_kinematicBody;
		default:													break;
		}

		WN_CORE_ASSERT(false, "Unknown body type");
	...
	void PhysicSystem2D::OnRuntiemStart()
	{
		...
		for (auto e : view)
		{
			...
			{
				//WN_CORE_ASSERT(entity.HasComponent<CircleRendererComponent>());
